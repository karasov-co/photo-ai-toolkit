...
from renderers.base import EngineUnavailable, Renderer, RenderError, register
...
class DarktableRenderer(_ExternalRenderer):
    ...
    def render(self, path: Path, recipe, *, max_px: int = 1024) -> Image.Image:
        ...
        from exporters.darktable_xmp import to_darktable_xmp
...
class RawTherapeeRenderer(_ExternalRenderer):
    ...
    def render(self, path: Path, recipe, *, max_px: int = 1024) -> Image.Image:
        ...
        from exporters.rawtherapee_pp3 import to_pp3
