...
from photoai import bootstrap, i18n, layout, pipeline, preflight, reports, stock_metadata, workspace
from photoai import overrides as overrides_module
from photoai import quarantine as quarantine_module
from photoai.calibration import BUILTIN_PROFILES, CalibrationProfile, resolve
...
def _write_outputs(
    ...
    *,
    ...
    one.
    """
    from photoai import batches, recipe_export, simple_report
...
def _confirm_cost(input_dir: Path, model: str, options) -> int | None:
    ...
    """
    from photoai import batches, media
...
def cmd_apply_recipe(args: argparse.Namespace) -> int:
    ...
    from photoai.edit_schema import read_recipe
...
def cmd_ask(args: argparse.Namespace) -> int:
    ...
    from photoai import active_learning, preference_model
...
def cmd_record(args: argparse.Namespace) -> int:
    ...
    from photoai.preference_store import Decision, PreferenceStore
...
def cmd_policy(args: argparse.Namespace) -> int:
    ...
    from photoai import selective_policy
...
src/photoai/data/marketplace_rules.json.
""",
        encoding="utf-8",
    )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    _providers = __import__("photoai.llm_provider", fromlist=["PROVIDERS"]).PROVIDERS
